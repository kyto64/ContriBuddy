    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between">
          <div>
            ...
            <p class="text-lg text-gray-600 mt-2">
              Based on your skills: {{ skillsSummary }}
            </p>
          </div>
          <RouterLink
            to="/skills"
      ...
      <div v-if="isLoading" class="text-center py-12">
        <div class="inline-flex items-center">
          ...
          <span class="text-xl text-gray-700">Finding perfect projects for you...</span>
        </div>
      </div>
      ...
      <div v-else-if="!userStore.hasSkills" class="text-center py-12">
        <div class="card max-w-md mx-auto">
          ...
          <h3 class="text-lg font-semibold text-gray-900 mb-2">Tell us about your skills</h3>
          <p class="text-gray-600 mb-4">We need to know your programming languages and interests to find the best projects for you.</p>
      ...
      <div v-else-if="recommendations.length > 0" class="space-y-6">
        <div class="flex items-center justify-between mb-6">
          <p class="text-sm text-gray-600">
            Found {{ recommendations.length }} projects
          </p>
      ...
      <div v-else class="text-center py-12">
        <div class="card max-w-md mx-auto">
          ...
          <p class="text-gray-600 mb-4">Try adjusting your skills or interests to find more projects.</p>
          <RouterLink to="/skills" class="btn-primary">
            Update Skills
          </RouterLink>
        </div>
...
const skillsSummary = computed(() => {
  ...
  if (allSkills.length === 0) return 'No skills selected'
